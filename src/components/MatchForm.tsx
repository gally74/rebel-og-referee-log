...
const styles: Record<string, React.CSSProperties> = {
  ...
  input: { width: '100%', padding: 10, borderRadius: 8, border: '1px solid var(--border)', background: 'var(--bg-card)', color: 'var(--text)' },
  ...
  scoreInput: { width: '100%', padding: 8, borderRadius: 8, border: '1px solid var(--border)', background: 'var(--bg-card)', color: 'var(--text)' },
  totalLine: { fontSize: 13, fontWeight: 600, color: 'var(--text-muted)', marginTop: 6 },
  resultLine: { marginTop: 12, padding: 10, background: 'rgba(0,0,0,0.06)', borderRadius: 8, fontSize: 14, fontWeight: 600 },
  button: { marginTop: 16, width: '100%', padding: 12, background: 'var(--accent)', color: 'var(--on-accent)', border: 'none', borderRadius: 8, fontWeight: 600 },
}
